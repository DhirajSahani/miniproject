jQuery(document).ready(function($) {
    'use strict';
    var this_obj = electronics_retailer_plugin_activate_plugin;

    $(document).on('click', '.electronics-retailer-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message electronics-retailer-plugin-install');
                button.addClass('button-primary electronics-retailer-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.electronics-retailer-recommended-plugins .electronics-retailer-activation-note').css('display','block');
    ...
    $(document).on('click', '.electronics-retailer-plugin-activate', function(event) {
    ...
    jQuery('#lite_theme .ibtana-skip-btn').click(function(){
        ...
        jQuery('#lite_theme .electronics-retailer-recommended-plugins').css('display','none');
    });

    jQuery('#block_pattern .ibtana-skip-btn').click(function(){
        var light_theme = jQuery(this).attr('get-start-tab-id');
        jQuery('.' + light_theme).css('display','block');
        jQuery('#block_pattern .electronics-retailer-recommended-plugins').css('display','none');
    });
