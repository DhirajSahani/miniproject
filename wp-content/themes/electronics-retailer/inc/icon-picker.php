...
class Electronics_Retailer_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <div class="social-icon-search">
                    <input class="socialInput" type="text" placeholder="<?php echo esc_attr_x( 'Icon', 'placeholder', 'electronics-retailer' ); ?>">
                </div>
                ...
                <ul class="icon-list clearfix">
                    <?php
                    $electronics_retailer_font_awesome_icon_array = electronics_retailer_font_awesome_icon_array();
                    foreach ($electronics_retailer_font_awesome_icon_array as $electronics_retailer_font_awesome_icon) {
                            $icon_class = $this->value() == $electronics_retailer_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($electronics_retailer_font_awesome_icon).'"></i>
                            <span class="electronics-retailer-social-class">'.esc_attr($electronics_retailer_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function electronics_retailer_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'electronics-retailer-customizer-script', esc_url(get_template_directory_uri()).'/assets/js/customizer-scripts.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'electronics_retailer_customizer_script' );

if(!function_exists('electronics_retailer_font_awesome_icon_array')){
    function electronics_retailer_font_awesome_icon_array(){
