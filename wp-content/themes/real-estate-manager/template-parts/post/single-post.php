...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    ...
    <div class="box-content">
        <?php the_content(); ?>
        <?php if(get_theme_mod('real_estate_manager_remove_tags',true) != ''){ 
            $tags = get_the_tags(); // Retrieve the post's tags
             real_estate_manager_custom_output_tags(); 
        }?>

        <?php if(get_theme_mod('real_estate_manager_remove_category',true) != ''){ 
            if(has_category()){ 
        ...
        <?php if( get_theme_mod( 'real_estate_manager_remove_comment',true) != ''){ 
        ...
        if ( is_singular( 'attachment' ) ) {
            ...
            the_post_navigation( array(
                'prev_text' => _x( '<span class="meta-nav">Published in</span><span class="post-title">%title</span>', 'Parent post link', 'real-estate-manager' ),
            ) );
        } elseif ( is_singular( 'post' ) ) {
            // Previous/next post navigation.
            the_post_navigation( array(
                'next_text' => '<span class="meta-nav" aria-hidden="true">' . __( 'Next:', 'real-estate-manager' ) . '</span> ' .
                    '<span class="post-title">%title</span>',
                'prev_text' => '<span class="meta-nav" aria-hidden="true">' . __( 'Previous:', 'real-estate-manager' ) . '</span> ' .
                    '<span class="post-title">%title</span>',
            ) );
        } ?>
